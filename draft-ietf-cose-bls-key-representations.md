...
- The parameter "d" MUST be present for private key representations with its value being the base64url encoding of the compressed serialized point format defined normatively in Appendix B of <xref target="BBS"/>. This parameter MUST NOT be present for public keys.
...
```
{
  "kty": "OKP",
  "crv": "BLS12381G2",
  "x": "TBD THIS IS NOW WRONG. REPLACE IT. aYylVK_x0F8HhE8zk0YWiGV3CHwpQ
Ea2sH4PBZLaYCn8se-1clmCORDsKxbbw3Js_Alu4OmkV9gmbJsy1YF2rt7Vxzs6S",
  "d": "TBD THIS IS NOW WRONG. REPLACE IT. svwjJhUM"
}
```
...
```
{
  "kty": "OKP",
  "crv": "BLS12381G2",
  "x": "TBD THIS IS NOW WRONG. REPLACE IT. XLd7zzMpFLeLdr-QQMJ2NPebFkw-h
CyWIj8dwP9uvuu9c9WZrVWvQnY2n7xQHF-BM-Mx6747t_ZJCu809fskA3ca3TVr7",
  "d": "TBD THIS IS NOW WRONG. REPLACE IT. VaI0tNhs"
}
```
...
```
{
  1: 1,
  -1: 14,
  -2: h'TBD THIS IS NOW WRONG. REPLACE IT. CDAF47031C5D007A32AF743779A14
...
43A0622A7CB13EDC3A001BDB12E45B16B60274D28DFBA48253B34D21',
  -4: h'TBD THIS IS NOW WRONG. REPLACE IT. 50F5858AAFD56EC038739E96F834F'
}
```
...
```
{
  1: 1,
  -1: 14,
  -2: h'TBD THIS IS NOW WRONG. REPLACE IT. 49E2228CAA0775A052AE6F1AE5737
...
8FC8F0BE26C329375B95B6B6D844CE981CED5934709E57ACA986F927',
  -4: h'TBD THIS IS NOW WRONG. REPLACE IT. 7305DEEA7631E23D1A27C46BD9F62'
}
```
